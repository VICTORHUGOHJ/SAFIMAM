...
global bandera_red_T_bess bandera_red_Pi_bess
...
bandera_red_T_bess = 0;
bandera_red_Pi_bess = 0;
...
global znbes Lbett_f Cbett_f Lbetpi_f Cbetpi_f Lbett_f_z Cbett_f_z Lbetpi_f_z Cbetpi_f_z
%j=0;
%k=0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global nbtp znbes Lbett_f_z Cbett_f_z vrs bandera_red_T_bess
bandera_red_T_bess = 1;
...
% Lbetpi_f_z Cbetpi_f_z
global nbtp znbes Lbetpi_f_z Cbetpi_f_z vrs bandera_red_Pi_bess
bandera_red_Pi_bess = 1;
...
% handles    structure with handles and user data (see GUIDATA)
global bandera_red_T_bess bandera_red_Pi_bess
if bandera_red_T_bess == 0 && bandera_red_Pi_bess == 0
