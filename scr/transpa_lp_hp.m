...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global f_paobp f_paobr nump_max denp_max nump_min denp_min Wc_hp syspmax_hp_f syspmin_hp_f pahp_frec
global bandera_calculo_hp 
bandera_calculo_hp = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global sysprs syspminrs npa denparcial numerador denminparcial numin nump_max denp_max nump_min denp_min valor_rs Lpabp_lp_t Cpabp_lp_t Cpabp_lp_pi Lpabp_lp_pi Lpabr_lp_t Cpabr_lp_t Cpabr_lp_pi Lpabr_lp_pi Wc_hp syspmax_hp_f syspmin_hp_f pahp_frec
global bandera_calculo_hp
pahp_frec=handles.pahp_frec;
if pahp_frec<=0 || ~isnumeric(pahp_frec) || ~isreal(pahp_frec) || isnan(pahp_frec)
warndlg('Enter Numerical real denormalization frequency','Warning');
else
if bandera_calculo_hp==0
