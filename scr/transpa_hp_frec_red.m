...
global Lpabp_hp_t_f Cpabp_lp_t Cpabp_hp_t_f Lpabp_lp_t Lpabr_hp_t_f Cpabr_lp_t Cpabr_hp_t_f Lpabr_lp_t Lpabp_hp_pi_f Cpabp_lp_pi Cpabp_hp_pi_f Lpabp_lp_pi Lpabr_hp_pi_f Cpabr_lp_pi Cpabr_hp_pi_f Lpabr_lp_pi Wc_hp
%j=0;
%k=0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global f_paobr f_paobp valor_rs npa Lpabp_lp_t Cpabp_lp_t Lpabr_lp_t Cpabr_lp_t Wc_hp Lpabp_hp_t_f Cpabp_hp_t_f Lpabr_hp_t_f Cpabr_hp_t_f
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global f_paobr f_paobp valor_rs npa Lpabp_lp_pi Cpabp_lp_pi Lpabr_lp_pi Cpabr_lp_pi Wc_hp Lpabp_hp_pi_f Cpabp_hp_pi_f Lpabr_hp_pi_f Cpabr_hp_pi_f 
