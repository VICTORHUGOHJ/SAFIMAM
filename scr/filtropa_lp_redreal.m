...
global sysprs syspminrs npa denparcial numerador denminparcial numin nump_max denp_max nump_min denp_min valor_rs bandera_red_T bandera_red_Pi
sysprs=varargin{1};
...
global numerador denparcial numin denminparcial valor_rs npa indpa capa capa_pi indpa_pi indpabr capabr capa_pibr indpa_pibr Lpabp_lp_t Cpabp_lp_t Lpabr_lp_t Cpabr_lp_t Lpabp_lp_pi Cpabp_lp_pi Lpabr_lp_pi Cpabr_lp_pi tawosnum_max taparealnum_max tawosden_max taparealden_max tawosnum_min taparealnum_min tawosden_min taparealden_min num1 den1 num2 den2
%j=0;
%k=0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global f_paobp f_paobr numerador denparcial numin denminparcial valor_rs npa indpa capa capa_pi indpa_pi indpabr capabr capa_pibr indpa_pibr Lpabp_lp_t Cpabp_lp_t Lpabr_lp_t Cpabr_lp_t tawosnum_max taparealnum_max tawosden_max taparealden_max tawosnum_min taparealnum_min tawosden_min taparealden_min num1 den1 num2 den2
global bandera_red_T
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global numerador denparcial numin denminparcial valor_rs npa indpa capa capa_pi indpa_pi indpabr capabr capa_pibr indpa_pibr Cpabp_lp_pi Lpabp_lp_pi Cpabr_lp_pi Lpabr_lp_pi tawosnum_max taparealnum_max tawosden_max taparealden_max tawosnum_min taparealnum_min tawosden_min taparealden_min num1 den1 num2 den2
global bandera_red_Pi f_paobp f_paobr
...
global sysprs syspminrs npa denparcial numerador denminparcial numin nump_max denp_max nump_min denp_min valor_rs Lpabp_lp_t Cpabp_lp_t Cpabp_lp_pi Lpabp_lp_pi Lpabr_lp_t Cpabr_lp_t Cpabr_lp_pi Lpabr_lp_pi tawosnum_max taparealnum_max tawosden_max taparealden_max tawosnum_min taparealnum_min tawosden_min taparealden_min num1 den1 num2 den2
global bandera_red_T bandera_red_Pi

if bandera_red_T==0 && bandera_red_Pi==0
