...
global bandera_red_T_z bandera_red_Pi_z
kb=varargin{1};
zb=varargin{2};
pb=varargin{3};
numb=varargin{4};
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global rs RL Lbu_lp_t Cbu_lp_t butlp_z nb nch1 nch2 ne f_but f_cheby1 f_cheby2 f_elip Lch1_lp_t Cch1_lp_t Lch2_lp_t Cch2_lp_t Le_lp_t Ce_lp_t 
global bandera_red_T_z
bandera_red_T_z = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global rs RL Lbu_lp_pi Cbu_lp_pi butlp_z nb nch1 nch2 ne f_but f_cheby1 f_cheby2 f_elip Lch1_lp_pi Cch1_lp_pi Lch2_lp_pi Cch2_lp_pi Le_lp_pi Ce_lp_pi 
global bandera_red_Pi_z
bandera_red_Pi_z = 1;
...
% handles    structure with handles and user data (see GUIDATA)
global kb zb pb numb denb rs RL Lbu_lp_t Cbu_lp_t sysbut_lp Lbu_lp_pi Cbu_lp_pi nb nch1 f_but f_cheby1 zc1 pc1 kc1 numch1 dench1 sysch1_lp Lch1_lp_pi Cch1_lp_pi Lch1_lp_t Cch1_lp_t f_cheby2 f_elip nch2 ne zc2 pc2 kc2 numch2 dench2 sysch2_lp ze pe ke nume dene syse_lp Lch2_lp_pi Cch2_lp_pi Le_lp_pi Ce_lp_pi Lch2_lp_t Cch2_lp_t Le_lp_t Ce_lp_t 
global Le_lp_t Ce_lp_t bandera_red_T_z bandera_red_Pi_z
if bandera_red_T_z == 0 && bandera_red_Pi_z == 0
