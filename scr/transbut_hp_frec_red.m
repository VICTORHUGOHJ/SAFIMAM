...
global bandera_red_T_hp bandera_red_Pi_hp 
kb=varargin{1};
zb=varargin{2};
pb=varargin{3};
numb=varargin{4};
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global rs RL Lbu_lp_t Cbu_lp_t nb Wc_hp Lch1_lp_t Cch1_lp_t nch1 f_but f_cheby1 f_cheby2 f_elip nch2 ne Lch2_lp_t Cch2_lp_t Le_lp_t Ce_lp_t Lbu_hp_t_f Cbu_hp_t_f Lch1_hp_t_f Cch1_hp_t_f Lch2_hp_t_f Cch2_hp_t_f Le_hp_t_f Ce_hp_t_f 
global bandera_red_T_hp
bandera_red_T_hp = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global rs RL Lbu_lp_pi Cbu_lp_pi Lch1_lp_pi Cch1_lp_pi nb Wc_hp f_but f_cheby1 nch1 f_cheby2 f_elip nch2 ne Lch2_lp_pi Cch2_lp_pi Le_lp_pi Ce_lp_pi Lbu_hp_pi_f Cbu_hp_pi_f Lch1_hp_pi_f Cch1_hp_pi_f Lch2_hp_pi_f Cch2_hp_pi_f Le_hp_pi_f Ce_hp_pi_f 
global bandera_red_Pi_hp
bandera_red_Pi_hp = 1;
...
global bandera_red_T_hp bandera_red_Pi_hp
if bandera_red_T_hp == 0 && bandera_red_Pi_hp == 0
