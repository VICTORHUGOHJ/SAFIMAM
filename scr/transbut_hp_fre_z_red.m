...
global bandera_red_T_hp_z bandera_red_Pi_hp_z
kb=varargin{1};
zb=varargin{2};
pb=varargin{3};
numb=varargin{4};
...
bandera_red_T_hp_z = 0;
bandera_red_Pi_hp_z = 0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global rs RL nb nch1 buthp_frec_z f_but f_cheby1 Lbu_hp_t_f Cbu_hp_t_f Lch1_hp_t_f Cch1_hp_t_f f_cheby2 f_elip nch2 ne Le_hp_t_f Ce_hp_t_f Lch2_hp_t_f Cch2_hp_t_f 
global bandera_red_T_hp_z
bandera_red_T_hp_z = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global rs RL nb nch1 f_but f_cheby1 buthp_frec_z Lbu_hp_pi_f Cbu_hp_pi_f Lch1_hp_pi_f Cch1_hp_pi_f f_cheby2 f_elip nch2 ne Le_hp_pi_f Ce_hp_pi_f Lch2_hp_pi_f Cch2_hp_pi_f 
global bandera_red_Pi_hp_z
bandera_red_Pi_hp_z = 1;
...
global kb zb pb numb denb rs RL Lbu_lp_t Cbu_lp_t sysbut_lp Lbu_lp_pi Cbu_lp_pi nb nch1 f_but f_cheby1 zc1 pc1 kc1 numch1 dench1 sysch1_lp Lch1_lp_pi Cch1_lp_pi Lch1_lp_t Cch1_lp_t f_cheby2 f_elip nch2 ne zc2 pc2 kc2 numch2 dench2 sysch2_lp ze pe ke nume dene syse_lp Lch2_lp_pi Cch2_lp_pi Le_lp_pi Ce_lp_pi Lch2_lp_t Cch2_lp_t Le_lp_t Ce_lp_t 
global bandera_red_T_hp_z bandera_red_Pi_hp_z 
if bandera_red_T_hp_z == 0 && bandera_red_Pi_hp_z == 0
