...
global sysprs syspminrs npa denparcial numerador denminparcial numin nump_max denp_max nump_min denp_min valor_rs Lpabp_lp_t Cpabp_lp_t Cpabp_lp_pi Lpabp_lp_pi Lpabr_lp_t Cpabr_lp_t Cpabr_lp_pi Lpabr_lp_pi Wn_lp syspmax_lp_f syspmin_lp_f bandera_calculo_rf
sysprs=varargin{1};
...
global bandera_calculo_rf
if bandera_calculo_rf==0
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global syspmax_lp_f syspmin_lp_f f_paobp f_paobr bandera_calculo_rf
%p1=get(handles.genrf_trans_palp_frec,'Value');
bandera_calculo_rf = 1;
