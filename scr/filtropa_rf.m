...
global np wc ws wsp amax amin nch1 sysp syspmin bandera_bp_rf_funt bandera_br_rf_funt
np=varargin{1};
wc=varargin{2};
ws=varargin{3};
wsp=varargin{4};
...
sysp=varargin{8};
syspmin=varargin{9};
bandera_bp_rf_funt = 0;
bandera_br_rf_funt = 0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global np wc ws wsp amax amin nch1 bandera_bp_rf_funt bandera_br_rf_funt
if bandera_bp_rf_funt == 0 && bandera_br_rf_funt == 0
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global sysp bandera_bp_rf_funt
bandera_bp_rf_funt = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global syspmin bandera_br_rf_funt
bandera_br_rf_funt = 1;
