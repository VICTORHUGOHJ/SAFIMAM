...
global bandera_red_T_elip bandera_red_Pi_elip 
nbtp=varargin{1};
sysbess=varargin{2};
%%%kbt=varargin{3}
%%%zbt=varargin{4}
...
valbot=varargin{5};
vrs=varargin{6};
bandera_red_T_elip = 0;
bandera_red_Pi_elip = 0;
...
global denbt numbt nbtp Lbett_f indpa Cbett_f capa Lbetpi_f indpa_pi Cbetpi_f capa_pi valbot vrs
%j=0;
%k=0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global nbtp numbt denbt indpa capa indpa_pi capa_pi Lbett_f Cbett_f vrs
global bandera_red_T_elip
bandera_red_T_elip = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global nbtp numbt denbt indpa capa indpa_pi capa_pi Lbetpi_f Cbetpi_f vrs
global bandera_red_Pi_elip
bandera_red_Pi_elip = 1;
...
global nbtp sysbess numbt denbt Lbett_f indpa Cbett_f capa Lbetpi_f indpa_pi Cbetpi_f capa_pi valbot vrs
global bandera_red_T_elip bandera_red_Pi_elip

if bandera_red_T_elip == 0 && bandera_red_Pi_elip == 0
