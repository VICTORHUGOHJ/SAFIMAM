function varargout = transbut_hp_frec_z_rf(varargin)
% TRANSBUT_HP_FREC_Z_RF MATLAB code for transbut_hp_frec_z_rf.fig
%      TRANSBUT_HP_FREC_Z_RF, by itself, creates a new TRANSBUT_HP_FREC_Z_RF or raises the existing
%      singleton*.
%
%      H = TRANSBUT_HP_FREC_Z_RF returns the handle to a new TRANSBUT_HP_FREC_Z_RF or the handle to
%      the existing singleton*.
%
%      TRANSBUT_HP_FREC_Z_RF('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRANSBUT_HP_FREC_Z_RF.M with the given input arguments.
%
%      TRANSBUT_HP_FREC_Z_RF('Property','Value',...) creates a new TRANSBUT_HP_FREC_Z_RF or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before transbut_hp_frec_z_rf_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to transbut_hp_frec_z_rf_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help transbut_hp_frec_z_rf

% Last Modified by GUIDE v2.5 06-Oct-2022 19:25:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @transbut_hp_frec_z_rf_OpeningFcn, ...
                   'gui_OutputFcn',  @transbut_hp_frec_z_rf_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before transbut_hp_frec_z_rf is made visible.
function transbut_hp_frec_z_rf_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to transbut_hp_frec_z_rf (see VARARGIN)
...
% Choose default command line output for transbut_hp_frec_z_rf
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes transbut_hp_frec_z_rf wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = transbut_hp_frec_z_rf_OutputFcn(hObject, eventdata, handles) 
...
global sysbut_hp_f sysch1_hp_f f_but f_cheby1 syse_hp_f sysch2_hp_f f_elip f_cheby2
...
% --- Executes on button press in fin19.
function fin19_Callback(hObject, eventdata, handles)
% hObject    handle to fin19 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clear,clc,close all
...
global kb zb pb numb denb rs RL Lbu_lp_t Cbu_lp_t sysbut_lp Lbu_lp_pi Cbu_lp_pi nb nch1 f_but f_cheby1 zc1 pc1 kc1 numch1 dench1 sysch1_lp Lch1_lp_pi Cch1_lp_pi Lch1_lp_t Cch1_lp_t f_cheby2 f_elip nch2 ne zc2 pc2 kc2 numch2 dench2 sysch2_lp ze pe ke nume dene syse_lp Lch2_lp_pi Cch2_lp_pi Le_lp_pi Ce_lp_pi Lch2_lp_t Cch2_lp_t Le_lp_t Ce_lp_t sysbut_hp_f sysch1_hp_f sysch2_hp_f syse_hp_f Wc_hp Lbu_hp_t_f Cbu_hp_t_f Lch1_hp_t_f Cch1_hp_t_f Lch2_hp_t_f Cch2_hp_t_f Le_hp_t_f Ce_hp_t_f Lbu_hp_pi_f Cbu_hp_pi_f Lch1_hp_pi_f Cch1_hp_pi_f Lch2_hp_pi_f Cch2_hp_pi_f Le_hp_pi_f Ce_hp_pi_f buthp_frec_z
set(gcf,'visible','off');
transbut_hp_fre_z_red(kb,zb,pb,numb,denb,rs,RL,Lbu_lp_t,Cbu_lp_t,sysbut_lp,Lbu_lp_pi,Cbu_lp_pi,nb,nch1,f_but,f_cheby1,zc1,pc1,kc1,numch1,dench1,sysch1_lp,Lch1_lp_pi,Cch1_lp_pi,Lch1_lp_t,Cch1_lp_t,f_cheby2,f_elip,nch2,ne,zc2,pc2,kc2,numch2,dench2,sysch2_lp,ze,pe,ke,nume,dene,syse_lp,Lch2_lp_pi,Cch2_lp_pi,Le_lp_pi,Ce_lp_pi,Lch2_lp_t,Cch2_lp_t,Le_lp_t,Ce_lp_t,sysbut_hp_f,sysch1_hp_f,sysch2_hp_f,syse_hp_f,Wc_hp,Lbu_hp_t_f,Cbu_hp_t_f,Lch1_hp_t_f,Cch1_hp_t_f,Lch2_hp_t_f,Cch2_hp_t_f,Le_hp_t_f,Ce_hp_t_f,Lbu_hp_pi_f,Cbu_hp_pi_f,Lch1_hp_pi_f,Cch1_hp_pi_f,Lch2_hp_pi_f,Cch2_hp_pi_f,Le_hp_pi_f,Ce_hp_pi_f,buthp_frec_z)


% --- Executes on button press in reg11.
function reg11_Callback(hObject, eventdata, handles)
% hObject    handle to reg11 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global kb zb pb numb denb rs RL Lbu_lp_t Cbu_lp_t sysbut_lp Lbu_lp_pi Cbu_lp_pi nb nch1 f_but f_cheby1 zc1 pc1 kc1 numch1 dench1 sysch1_lp Lch1_lp_pi Cch1_lp_pi Lch1_lp_t Cch1_lp_t f_cheby2 f_elip nch2 ne zc2 pc2 kc2 numch2 dench2 sysch2_lp ze pe ke nume dene syse_lp Lch2_lp_pi Cch2_lp_pi Le_lp_pi Ce_lp_pi Lch2_lp_t Cch2_lp_t Le_lp_t Ce_lp_t
set(gcf,'visible','off');
