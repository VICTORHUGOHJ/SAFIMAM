...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global f_paobp f_paobr nump_max denp_max nump_min denp_min Wc_bs Bw_bs syspmax_bs_f syspmin_bs_f pabs_frec pabs_bw
global bandera_calculo_bs
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global sysprs syspminrs npa denparcial numerador denminparcial numin nump_max denp_max nump_min denp_min valor_rs Lpabp_lp_t Cpabp_lp_t Cpabp_lp_pi Lpabp_lp_pi Lpabr_lp_t Cpabr_lp_t Cpabr_lp_pi Lpabr_lp_pi Wc_bs Bw_bs syspmax_bs_f syspmin_bs_f pabs_frec pabs_bw 
global bandera_calculo_bs 
pabs_frec=handles.pabs_frec;
pabs_bw=handles.pabs_bw;
if pabs_frec<=0 || ~isnumeric(pabs_frec) || ~isreal(pabs_frec) || pabs_bw<=0 || ~isnumeric(pabs_bw) || ~isreal(pabs_bw) || isnan(pabs_frec) || isnan(pabs_bw)
