...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global f_paobr f_paobp valor_rs npa palp_frec_z Lpabp_lp_t_f Cpabp_lp_t_f Lpabr_lp_t_f Cpabr_lp_t_f 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global f_paobr f_paobp valor_rs npa palp_frec_z Cpabp_lp_pi_f Lpabp_lp_pi_f Cpabr_lp_pi_f Lpabr_lp_pi_f bandera_red_Pi_z 
bandera_red_Pi_z  = 1;
