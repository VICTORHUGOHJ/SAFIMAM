...
Lbu_serie_bp_t_f=round(Lbu_lp_t./Bw_bp,6);
Cbu_serie_bp_t_f=round((Lbu_lp_t.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Lbu_paralelo_bp_t_f=round((Cbu_lp_t.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Cbu_paralelo_bp_t_f=round(Cbu_lp_t./Bw_bp,6);
...
Lch2_serie_bp_t_f=round(Lch2_lp_t./Bw_bp,6);
Cch2_serie_bp_t_f=round((Lch2_lp_t.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Lch2_paralelo_bp_t_f=round((Cch2_lp_t.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Cch2_paralelo_bp_t_f=round(Cch2_lp_t./Bw_bp,6);
Le_serie_bp_t_f=round(Le_lp_t./Bw_bp,6);
Ce_serie_bp_t_f=round((Le_lp_t.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Le_paralelo_bp_t_f=round((Ce_lp_t.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Ce_paralelo_bp_t_f=round(Ce_lp_t./Bw_bp,6);
Lbu_serie_bp_pi_f=round(Lbu_lp_pi./Bw_bp,6);
Cbu_serie_bp_pi_f=round((Lbu_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Lbu_paralelo_bp_pi_f=round((Cbu_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Cbu_paralelo_bp_pi_f=round(Cbu_lp_pi./Bw_bp,6);
Lch1_serie_bp_pi_f=round(Lch1_lp_pi./Bw_bp,6);
Cch1_serie_bp_pi_f=round((Lch1_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Lch1_paralelo_bp_pi_f=round((Cch1_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Cch1_paralelo_bp_pi_f=round(Cch1_lp_pi./Bw_bp,6);
Lch2_serie_bp_pi_f=round(Lch2_lp_pi./Bw_bp,6);
Cch2_serie_bp_pi_f=round((Lch2_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Lch2_paralelo_bp_pi_f=round((Cch2_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Cch2_paralelo_bp_pi_f=round(Cch2_lp_pi./Bw_bp,6);
Le_serie_bp_pi_f=round(Le_lp_pi./Bw_bp,6);
Ce_serie_bp_pi_f=round((Le_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Le_paralelo_bp_pi_f=round((Ce_lp_pi.^-1)*(Bw_bp/(Wc_bp*Wc_bp)),6);
Ce_paralelo_bp_pi_f=round(Ce_lp_pi./Bw_bp,6);
...
set(handles.rd_buttran_bp_frec,'String','Red tipo T');
...
set(handles.rd_buttran_bp_frec,'String','Red tipo π');
if f_but == 1 && f_cheby1==0 && f_cheby2==0 && f_elip==0
%Resistores
erres=string({'Rs= ','RL= '});
Res=string([rs RL]); 
