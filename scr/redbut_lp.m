...
global bandera_red_T bandera_red_Pi bandera_rs_guardada
nb=varargin{1};
...
%open_system('sim1')
global nb wc wsp amax amin rs RL Lbu_lp_t Cbu_lp_t nch1 f_but f_cheby1 Lch1_lp_t Cch1_lp_t f_cheby2 f_elip nch2 ne Lch2_lp_t Cch2_lp_t Le_lp_t Ce_lp_t Lbu Cbu Lch1 Cch1 Lch2 Cch2 Le Ce rd
global bandera_red_T
global bandera_rs_guardada
bandera_red_T = 1;
%j=get(handles.redtbut_lp,'Value');
%
RL=1; %Resistencia de Carga
%Ladderbut=1; %tipo de Red 1 para tipo T y 2 para tipo pi
if bandera_rs_guardada==0
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global nb wc wsp amax amin rs RL Lbu_lp_pi Cbu_lp_pi nch1 f_but f_cheby1 Lch1_lp_pi Cch1_lp_pi f_cheby2 f_elip nch2 ne Lch2_lp_pi Cch2_lp_pi Le_lp_pi Ce_lp_pi Lbu_pi Cbu_pi Lch1_pi Cch1_pi Lch2_pi Cch2_pi Le_pi Ce_pi rd
global bandera_red_Pi
global bandera_rs_guardada 
bandera_red_Pi = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global wc wsp amax amin nb nch1 nch2 ne Lbu Cbu Lch1 Cch1 Lch2 Cch2 Le Ce Lbu_pi Cbu_pi Lch1_pi Cch1_pi Lch2_pi Cch2_pi Le_pi Ce_pi rs 
global bandera_rs_guardada
global bandera_red_T bandera_red_Pi
%red tipo t
bandera_rs_guardada = 1;
bandera_red_T = 0;
bandera_red_Pi = 0;
set(handles.rd,'String'," ")
cla(handles.rdbut_lp,'reset')
