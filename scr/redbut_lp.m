...
dene=varargin{35}
syse_lp=varargin{36}
% f_cheby2 f_elip nch2 ne zc2 pc2 kc2 numch2 dench2 sysch2_lp ze pe ke nume dene syse_lp
...
if l==0
 ...
 warndlg('Guardar el valor de Rs','Advertencia')
else
set(handles.rd,'String','Red tipo T');
rd=get(handles.rd,'String')
rs=handles.rs;
...
set(handles.rd,'String','Red tipo π');
rd=get(handles.rd,'String')
 rs=handles.rs;
if f_but == 1 && f_cheby1==0 && f_cheby2==0 && f_elip==0
...
if rs<0 || ~isnumeric(rs) || ~isreal(rs) || isnan(rs)
 msgbox('Colocar un valor de Rs real y mayor que cero','Advertencia');
else
if j==0 && k==0
 warndlg('Generar la Red Eléctrica','Advertencia')
else
d1=strcmp(rd,'NaN')
d2=strcmp(rd,'Red tipo π')
d3=strcmp(rd,'Red tipo T')
if d1==1
 warndlg('Guardar valor de Rs','Advertencia')
else
