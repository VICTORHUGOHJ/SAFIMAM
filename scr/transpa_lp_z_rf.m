...
global bandera_calculo_z_rf_lp
sysprs=varargin{1};
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global sysprs syspminrs f_paobp f_paobr bandera_calculo_z_rf_lp
bandera_calculo_z_rf_lp = 1;
