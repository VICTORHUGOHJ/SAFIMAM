...
global bandera_red_T_z_red bandera_red_Pi_z_red
sysprs=varargin{1};
...
palp_z=varargin{21};
bandera_red_T_z_red = 0;
bandera_red_Pi_z_red = 0;
...
global f_paobr f_paobp valor_rs npa palp_z Lpabp_lp_t Cpabp_lp_t Lpabr_lp_t Cpabr_lp_t 
global bandera_red_T_z_red
bandera_red_T_z_red = 1;
...
% handles    structure with handles and user data (see GUIDATA)
%Lpabp_lp_t Cpabp_lp_t Cpabp_lp_pi Lpabp_lp_pi Lpabr_lp_t Cpabr_lp_t Cpabr_lp_pi Lpabr_lp_pi
global f_paobr f_paobp valor_rs npa palp_z Cpabp_lp_pi Lpabp_lp_pi Cpabr_lp_pi Lpabr_lp_pi
global bandera_red_Pi_z_red
bandera_red_Pi_z_red = 1;
...
global bandera_red_T_z_red bandera_red_Pi_z_red
if bandera_red_T_z_red == 0 && bandera_red_Pi_z_red == 0
