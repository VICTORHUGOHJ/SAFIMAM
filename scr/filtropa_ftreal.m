...
%npx=str2double(string(npx));
%guidata(hObject,handles); 
%set(handles.valor_rs,'String'," ")
global p1 p2
p1=0
p2=0
...
warndlg('Ingresar valor de Rs real numerica','Advertencia');
p1=0
else
...
if p1==0 && p2==0
    warndlg('Generar Función de Transferencia','Advertencia');
else
set(gcf,'visible','off');
