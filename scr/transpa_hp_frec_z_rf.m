...
global bandera_calculo_hp_z_rf 
sysprs=varargin{1};
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global syspmax_hp_f syspmin_hp_f f_paobp f_paobr bandera_calculo_hp_z_rf 
bandera_calculo_hp_z_rf  = 1;
