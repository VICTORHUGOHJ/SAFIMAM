...
global np wc ws wsp amax amin nch1 bandera_bp_funt bandera_br_funt
np=varargin{1}
wc=varargin{2}
ws=varargin{3}
wsp=varargin{4}
...
global sysp syspmin np amax wsp amin
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global np amax sysp bandera_bp_funt
bandera_bp_funt = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global np wsp amin syspmin bandera_br_funt
bandera_br_funt = 1;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global np wc ws wsp amax amin nch1 sysp syspmin bandera_bp_funt bandera_br_funt
if bandera_bp_funt == 0 && bandera_br_funt == 0
