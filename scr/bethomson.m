...
global nbtp_1 nbtp_2
global bandera_calculo_orden bandera_tipo_retardo bandera_tipo_orden
bandera_calculo_orden = 0;
bandera_tipo_retardo = 0;
bandera_tipo_orden = 0;    
nbtp_1=0;
nbtp_2=0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global retardo Desatt f nbtp nbtp_1 nbtp_2
global bandera_calculo_orden bandera_tipo_retardo bandera_tipo_orden
retardo=handles.retardo;
Desatt=handles.Desatt;
f=handles.f;
if bandera_tipo_retardo==1

loge=0.43429448190;
%p1=get(handles.pushbutton1,'Value');
bandera_calculo_orden = 1;
...
global Desatt f retardo nbtp_2 nbtp_1 nbtp
global bandera_tipo_retardo bandera_tipo_orden

bandera_tipo_retardo = 1;
bandera_tipo_orden = 0;
...
global nbtp_2 Desatt f retardo nbtp_1 nbtp
global bandera_tipo_retardo bandera_tipo_orden
bandera_tipo_retardo = 0;
bandera_tipo_orden = 1;
nbtp_1=0;
nbtp_2=0;
nbtp=0;
Desatt=0;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global nbtp_2 nbtp_1 bandera_calculo_orden bandera_tipo_orden
if bandera_tipo_orden==1
nbtp_1=0;
